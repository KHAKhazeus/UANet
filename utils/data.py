...
class Data:
    ...
    def show_data_summary(self):
        ...
        print("     Hyper         clip: %s"%(self.clip_grad))
        ...
        print("     Hyper      model1_layer: %s"%(self.HP_model1_layer))
        print("     Hyper      model2_layer: %s" % (self.HP_model2_layer))
    ...
    def read_config(self,args):
        ...
        self.HP_label_embedding_scale = float(args.label_embedding_scale)
